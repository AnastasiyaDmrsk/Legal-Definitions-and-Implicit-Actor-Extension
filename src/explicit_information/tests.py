...
gold = 'src/gold_standard/32021R0444.csv'
result = 'src/results/relation.csv'
...
# choose a gold standard file to test
gold_sentences = 'src/gold_standard/32021R0444S.csv'
result_sentences = 'src/results/sentences.csv'


def compare_sentences():
    sent_set = views.get_sentences()
    file_path = os.path.join('results', 'sentences.csv')
